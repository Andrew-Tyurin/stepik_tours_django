...
# @dataclass автоматически создаёт __init__
@dataclass
class Tours:
    title: str
    description: str
...
tours = {
    ...
    17: Tours(
        title="Langham Place Guangzhou",
        description="Роскошный отель Guangzhou Langham находится всего в 2 минутах ходьбы от международного выставочного "
                    "центра Пачжоу. К услугам гостей крытый бассейн, 5 кафе и ресторанов и роскошные номера с "
                    "высококлассными удобствами, оформленные в светлых тонах. До телебашни Гуанчжоу 10 минут езды. "
                    "От отеля Langham до станции метро Xinggangdong 5 минут ходьбы, а до района Новый город Чжуцзян можно "
                    "доехать за 15 минут. Поездка до международного аэропорта Гуанчжоу-Байюнь занимает 45 минут. До "
                    "туристического комплекса Guangzhou Chimelong 20 минут езды.",
        departure="msk",
        picture="https://cf.bstatic.com/xdata/images/hotel/max1024x768/536113994.jpg?k=f1a5000c22be1aeda9350e17704189725abe34b31dd88b7b7ba36ea8691b1630&o=",
        price=99999,
        stars=5,
        country="Китай",
        nights=20,
